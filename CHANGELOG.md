...
### Added
- Auto-labeling: label changes to the WooCommerce Analytics package.
...
[5.1.0-alpha]: https://github.com/Automattic/action-repo-gardening/compare/v5.0.0...v5.1.0-alpha
